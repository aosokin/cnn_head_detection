function res = vl_simplenn_localModel(net, x, dzdy, res, varargin)
%vl_simplenn_localModel is based on the vl_simplenn function of MatConvNet with almost no changes
